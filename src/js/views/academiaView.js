                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-6 f-weigth-600">
                        ...
                        <p className="text-justify text-gray">
                            ...
                            <br />
                            4. En caso de que finalmente las restricciones no nos permitieran realizar el plan vacacional de modalidad presencial, se adaptará la modalidad a virtual hasta que se pueda volver a la presencialidad.
                        </p>
                        <br />
                        <p className="text-justify text-gray mt-5">
