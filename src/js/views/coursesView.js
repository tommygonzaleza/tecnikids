            ...
            <SeparationLines />
                <div className="container">
                    <div className="row">
                        ...
                        <h3 className="row col-12">SMART ENGLISH</h3>
                        <div className="row">
                            <p className="col-12 col-md-6 justify-text my-3">
                        ...
                        <div className="row mt-5">
                            ...
                            <br />
                            <br />
                            <h4 className="col-12">TOEFL Primary Step 1 (CEFR A2):</h4>
                            <p className="col-12 justify-text">
                            ...
                            <br />
                            <br />
                            <h4 className="col-12">TOEFL Primary Step 2 (CEFR B1):</h4>
                            <p className="col-12 justify-text">
                                Examen institucional diseñado para certificar el idioma inglés para 
                            ...
                            <br />
                            <br />
                            <h4 className="col-12">TOEFL Junior (CEFR B2):</h4>
                            <p className="col-12 justify-text">
                                Examen institucional diseñado para certificar el idioma inglés para 
                            ...
                            <br />
                            <br />
                            <h4 className="col-12">Criterion y Speaking:</h4>
                            <p className="col-12 justify-text">
                            ...
                            <br />
                            <br />
                            <h4 className="col-12">TOEFL ITP Level 1 (CEFR C1):</h4>
                            <p className="col-12 justify-text">
                            ...
                            <br />
                            <br />
                            <h4 className="col-12">TOEFL ITP Level 2 (CEFR B1):</h4>
                            <p className="col-12 justify-text">
                                Examen institucional diseñado para certificar el nivel de inglés 
                                para programas universitarios.
                            </p>
                        ...
                        <div className="row">
                            <Button className="col-3 my-5 p-center" variant="primary" href="http://smartenglishonline.com.mx/">MÁS INFORMACIÓN</Button>
                        </div>
