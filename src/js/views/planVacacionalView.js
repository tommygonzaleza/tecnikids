            ...
            <div className="container mx-auto text-secondary f-weigth-600 pl-3">
                ...
                <div className="row">
                    <div className="col-12 text-center">
                        ...
                        <p>3. Al optar por la modalidad Semi Presencial deberá leer y firmar la Planilla de Condiciones Generales <a className="planilla-link" href="https://drive.google.com/file/d/1IX8N7BTg-DTFT_EvQXsluZFMm_-Y8L7n/view?usp=sharing" target="_blank">(Descarga aquí)</a>.</p>
