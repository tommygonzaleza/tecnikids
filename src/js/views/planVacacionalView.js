            ...
            <div className="container mx-auto text-secondary f-weigth-600 pl-3">
                ...
                <div className="row">
                    <div className="col-12 text-center">
                        ...
                        <p>3. Al optar por la modalidad Semi Presencial deberá leer y firmar la Planilla de Condiciones Generales <a className="planilla-link" href="/planilla_aceptacion_de_condiciones_campamento_tecnikids.pdf" target="_blank" download="Planilla Aceptacion de Condiciones - Campamento Tecnkids.pdf">(Descarga aquí)</a>.</p>
