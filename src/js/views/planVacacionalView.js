            ...
            <div className="container mx-auto text-secondary f-weigth-600">
                ...
                <div className="row">
                    <div className="col-12 text-center">
                        ...
                        <p>3. Al optar por la modalidad Semi Presencial deberá leer y firmar la Planilla de Condiciones Generales <Link className="planilla-link" to="/planilla_aceptacion_de_condiciones_campamento_tecnikids.docx" target="_blank" download>(Descarga aquí)</Link>.</p>
