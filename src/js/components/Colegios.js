        ...
        <div className="container my-5">
            ...
            <div className="row w-auto my-3">
                ...
                <div className="col-12">
                    ...
                    <a href="https://www.colegioloscampitos.com/el_colegio.htm"><img src="https://i.ibb.co/60Q5sW5/logo-los-campitos.png" alt="Colegio Los Campitos" className="col-md-2 col-3"/></a>
                    <a href="https://www.eduweb.com.ve/portal/academiamerici/index.php?option=com_jevents&task=modcal.ajax&day=1&month=9&year=2017&modid=91&tmpl=component"><img src="https://i.ibb.co/TK4CPsf/logo-merici-01.png" alt="Academia Merici" className="col-md-2 col-3" style={{width: "23vw"}}/></a>
                    ...
                    <a href="#"><img src="https://i.ibb.co/rkYzMCB/logo-CEAMM.png" alt="CEAMM" className="col-md-2 col-4"/></a>
                    <a href="#"><img src="https://i.ibb.co/xjppgHf/Colegio-San-Agustin-El-Paraiso.png" alt="Colegio San Agustin del Paraiso" className="col-md-2 col-4"/></a>
                    <a href="#"><img src="https://i.ibb.co/mB5Ksyy/Mater-Mcbo-color-y-azul.png" alt="Mater Salvatoris" className="col-md-2 col-4"/></a>
                    <a href="#"><img src="https://i.ibb.co/SKBDR6L/Caracas-La-Colina-01-color-1-1.png" alt="La Salle La Colina" className="col-md-2 col-4"/></a>
                    <a href="#"><img src="https://i.ibb.co/dD4sYL5/unnamed-3.jpg" alt="MS" className="col-md-2 col-4"/></a>
                    <a href="#"><img src="https://i.ibb.co/jfTFDdJ/Henry-Clay.png" alt="Henry Clay" className="col-md-2 col-4"/></a>
