    ...
    return(
        <div className="row">
            <div className="col-12 col-md-3 ml-md-0 ml-4">
                <img className="col-8 ml-2 p-center" src="https://i.ibb.co/LhHbhXK/creativos-icon.png" alt="Creativos"/>
            ...
            <div className="col-12 col-md-3 ml-md-0 ml-4">
                <img className="col-8 ml-2 p-center" src="https://i.ibb.co/hKCPPd0/tecnologicos-icon.png" alt="Tecnológicos" />
            ...
            <div className="col-12 col-md-3 ml-md-0 ml-4">
                <img className="col-8 ml-2 p-center" src="https://i.ibb.co/ygt6tMK/constructivos-icon.png" alt="Constructivos" />
            ...
            <div className="col-12 col-md-3 ml-md-0 ml-4">
                <img className="col-8 ml-2 p-center" src="https://i.ibb.co/6sK2MHh/estructurados-icon.png" alt="Estructurados" />
