  ...
  },
  {
    ...
    challenge: {
      ...
      bullets: [
        ...
        "El jugador debe mirar a donde se está moviendo.",
        "Emplea operadores o sensores.",
        "Cambios de fondo.",
        "Un cambio de disfraz donde uno de los disfraces debe ser creado a partir de modificar la apariencia inicial del disfraz.",
        "Bloques de sonido.",
