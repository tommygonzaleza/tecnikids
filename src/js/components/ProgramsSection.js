...
export const ProgramsSection = () => {
    return(
        <div className="col-11 p-center mb-5 mt-1 mx-0 p-0">
            ...
            <a className="col-12 col-md-2 px-0" href="/ponte-en-linea-view"><img className="col-3 col-md-2" src={ponteEnLinea} alt="Ponte En Línea" /></a>
            <a className="col-12 col-md-2 px-0" href="https://www.python.org/"><img className="col-3 col-md-2" src={python} alt="Python" /></a>
