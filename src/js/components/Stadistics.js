            ...
            <div className="row mx-0">
                <div className="col-10 col-md-2 m-3 mx-auto m-md-5">
                    ...
                    <div className="col-12 center-text">
                        <CountUp
                            className="stadistics-title font-face-gothamrnd-bold"
                            delay={2}
                            end={3}
                            duration={7}
                        />
                    </div>
                    <p className="stadistics-text font-face-gothamrnd-bold">Años</p>
                </div>
                <div className="col-10 col-md-2 m-3 mx-auto m-md-5">
                    ...
                    <p className="stadistics-text font-face-gothamrnd-bold">Colegios</p>
                </div>
                <div className="col-10 col-md-2 m-3 mx-auto m-md-5">
                    ...
                    <p className="stadistics-text font-face-gothamrnd-bold">Estudiantes</p>
                </div>
                <div className="col-10 col-md-2 m-3 mx-auto m-md-5">
                    ...
                    <p className="stadistics-text font-face-gothamrnd-bold">Estados</p>
                </div>
            </div>
        </div>
    )
